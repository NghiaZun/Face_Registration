...
vsi_nn_graph_t * vnn_CreateResnet34Fp16
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Gemm_/fc/Gemm/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 128;
    attr.size[1] = 1;
    attr.dim_num = 2;
...
error:
    ...
    vnn_ReleaseResnet34Fp16( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateResnet34Fp16() */

void vnn_ReleaseResnet34Fp16
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
